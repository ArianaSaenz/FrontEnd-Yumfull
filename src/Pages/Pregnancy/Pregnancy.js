...
<div className="image-container">
  <div className="nutrition-image">
   <img src="images/1woman.png" alt="Pregnant Woman" />
      ...
      <div className="section-content">
        <div className="card">
          <div className="card-image"> <img src="images/2woman.png" alt="Pregnant Woman" /></div>
...
<div className="foods-container recommended">
  ...
  <div className="food-image-container almonds">
    <img src="images/almonds.png" alt="Almonds" />
  </div>
...
<div className="foods-container avoid">
  <div className="food-card">
    <div className="food-image-container mortadella">
      <img src="images/mortadella.png" alt="Mortadella" />
    </div>
  ...
  <div className="food-card">
    <div className="food-image-container tuna">
      <img src="images/bluefin tuna.png" alt="Bluefin Tuna" />
    </div>
